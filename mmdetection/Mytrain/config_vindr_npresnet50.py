#   CUDA_VISIBLE_DEVICES=1 python tools/train.py Mytrain/demo.py
#   CUDA_VISIBLE_DEVICES=1 nohup python tools/train.py Mytrain/config_vindr_npresnet50_1205.py > LOG_tmp.txt &
import os
os.environ['WANDB_DATA_DIR'] = os.getcwd() + "./wandb/"
os.environ['WANDB_CACHE_DIR'] = os.getcwd() + "./wandb/.cache/"

Name = 'seed45'
Group = '_1217coslr_resnet50_nopr_224'
_base_ = '../configs/scratch/faster_rcnn_r50_fpn_gn-all_scratch_6x_coco.py'

custom_imports = dict(imports=['mmcls.models'], allow_failed_imports=False)
checkpoint_file = 'Noop.pth' 
